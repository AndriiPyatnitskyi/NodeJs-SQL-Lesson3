...
accountRouter.get('/api/accounts', permit([Role.USER, Role.ADMIN]), controller.getAccounts);
accountRouter.get('/api/accounts/:id', permit([Role.USER, Role.ADMIN]), controller.getAccountById);
accountRouter.post('/api/accounts', permit([Role.USER, Role.ADMIN]), controller.createAccount);
accountRouter.put('/api/accounts/:id', permit([Role.USER, Role.ADMIN]), controller.updateAccount);
